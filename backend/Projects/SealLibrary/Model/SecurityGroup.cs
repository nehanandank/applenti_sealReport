    ...
    public class SecurityGroup : RootEditor
    {
        ...
        protected override void UpdateEditorAttributes()
        {
            if (_dctd != null)
            {
                ...
                GetProperty("CSVExportName").SetIsBrowsable(true);
        ...
        /// </summary>
        [Category("Default Options"), DisplayName("\tCSVExportName file name"), Description("The CSVExportName file name used for to generate the reports. If empty, the default logo is used."), Id(4, 5)]
        public string CSVExportName { get; set; }
